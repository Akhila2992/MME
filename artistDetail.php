...
$artistid= $_GET['id'];
 $statement = $db->prepare("Select song_id,song_name,song_file_path from as3995_info556_201602.mme_songs where song_artist_id=:artistid");
    $statement->execute(array(':artistid'=>$artistid));
